...
static SQLiteManager* SharedDatabase = nil;
...
+ (id) sharedDatabase
{
	@synchronized (self) {
        ...
        {
			SharedDatabase = [SQLiteManager new];
		}
	}
...
- (void)createDatabaseInApplicationDirectory {
    ...
    NSString *writableDBPath = [NSString stringWithFormat: @"%@/Craft.sqlite", documentsDirectory];
    ...
    NSError *error;
	NSString *defaultDBPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"Craft.sqlite"];
